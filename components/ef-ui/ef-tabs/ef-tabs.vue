    ...
    <view class="u-tabs" :style="{
        ...
        <view :id="id">
            <scroll-view scroll-x class="u-scroll-view" :scroll-left="scrollLeft" scroll-with-animation>
                <view class="u-scroll-box flex" :class="{'u-tabs-scorll-flex': !isScroll}">
                    <view class="" :id="'u-tab-item-' + index" v-for="(item, index) in data" :key="index" @tap="clickTab(index)" :style="[tabItemStyle(index)]">
