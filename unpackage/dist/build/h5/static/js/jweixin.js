!function (e, n) {
    ...
    function i(n, i, t) {
        ...
        "openEnterpriseChat" == e && (n.errCode = n.err_code), delete n.err_code, delete n.err_desc, delete n.err_detail; let t = n.errMsg; t || (t = n.err_msg, delete n.err_msg, t = s(e, t), n.errMsg = t), (i = i || {})._complete && (i._complete(n), delete i._complete), t = n.errMsg || "", A.debug && !i.isInnerInvoke && alert(JSON.stringify(n)); let o = t.indexOf(":"); switch (t.substring(o + 1)) {
            case "ok": i.success && i.success(n); break; case "cancel": i.cancel && i.cancel(n); break; default: i.fail && i.fail(n);
        }i.complete && i.complete(n);
    } function s(e, n) {
        let i = e, t = h[i]; t && (i = t); let o = "ok"; if (n) {
            let r = n.indexOf(":"); "confirm" == (o = n.substring(r + 1)) && (o = "ok"), "failed" == o && (o = "fail"), -1 != o.indexOf("failed_") && (o = o.substring(7)), -1 != o.indexOf("fail_") && (o = o.substring(5)), "access denied" != (o = (o = o.replace(/_/g, " ")).toLowerCase()) && "no permission to execute" != o || (o = "permission denied"), "config" == i && "function not exist" == o && (o = "ok"), "" == o && (o = "fail");
        } return n = i + ":" + o;
    } function d(e) {
        if (e) {
            for (let n = 0, i = e.length; n < i; ++n) {
                let t = e[n], o = g[t]; o && (e[n] = o);
            } return e;
        }
    } function l(e, n) {
        if (!(!A.debug || n && n.isInnerInvoke)) {
            let i = h[e]; i && (e = i), n && n._complete && delete n._complete, console.log("\"" + e + "\",", n || "");
        }
    } function u(e) {
        if (!(_ || w || A.debug || M < "6.0.2" || V.systemType < 0)) {
            let n = new Image; V.appId = A.appId, V.initTime = C.initEndTime - C.initStartTime, V.preVerifyTime = C.preVerifyEndTime - C.preVerifyStartTime, N.getNetworkType({
                isInnerInvoke: !0, success: function (e) {
                    V.networkType = e.networkType; let i = "https://open.weixin.qq.com/sdk/report?v=" + V.version + "&o=" + V.isPreVerifyOk + "&s=" + V.systemType + "&c=" + V.clientVersion + "&a=" + V.appId + "&n=" + V.networkType + "&i=" + V.initTime + "&p=" + V.preVerifyTime + "&u=" + V.url; n.src = i;
                }
            });
        }
    } function p() {
        ...
        var g = { config: "preVerifyJSAPI", onMenuShareTimeline: "menu:share:timeline", onMenuShareAppMessage: "menu:share:appmessage", onMenuShareQQ: "menu:share:qq", onMenuShareWeibo: "menu:share:weiboApp", onMenuShareQZone: "menu:share:QZone", previewImage: "imagePreview", getLocation: "geoLocation", openProductSpecificView: "openProductViewWithPid", addCard: "batchAddCard", openCard: "batchViewCard", chooseWXPay: "getBrandWCPayRequest", openEnterpriseRedPacket: "getRecevieBizHongBaoRequest", startSearchBeacons: "startMonitoringBeacons", stopSearchBeacons: "stopMonitoringBeacons", onSearchBeacons: "onBeaconsInRange", consumeAndShareCard: "consumedShareCard", openAddress: "editAddress" }, h = function () {
            let e = {}; for (let n in g) e[g[n]] = n; return e;
        }(), S = e.document, y = S.title, v = navigator.userAgent.toLowerCase(), I = navigator.platform.toLowerCase(), _ = !(!I.match("mac") && !I.match("win")), w = -1 != v.indexOf("wxdebugger"), T = -1 != v.indexOf("micromessenger"), k = -1 != v.indexOf("android"), x = -1 != v.indexOf("iphone") || -1 != v.indexOf("ipad"), M = function () {
            let e = v.match(/micromessenger\/(\d+\.\d+\.\d+)/) || v.match(/micromessenger\/(\d+\.\d+)/); return e ? e[1] : "";
        }(), C = { initStartTime: p(), initEndTime: 0, preVerifyStartTime: 0, preVerifyEndTime: 0 }, V = { version: 1, appId: "", initTime: 0, preVerifyTime: 0, networkType: "", isPreVerifyOk: 1, systemType: x ? 1 : k ? 2 : -1, clientVersion: M, url: encodeURIComponent(location.href) }, A = {}, P = { _completes: [] }, L = { state: 0, data: {} }; f(function () {
            C.initEndTime = p();
        }); var B = !1, O = [], N = {
            config: function (e) {
                A = e, l("config", e); let n = !1 !== A.check; f(function () {
                    if (n) i(g.config, { verifyJsApiList: d(A.jsApiList) }, function () {
                        ...
                        }; let e = P._completes; return e.push(function () {
                            u();
                        }), P.complete = function (n) {
                            for (let i = 0, t = e.length; i < t; ++i)e[i](); P._completes = [];
                        }, P;
                    }()), C.preVerifyStartTime = p(); else {
                        L.state = 1; for (let e = P._completes, t = 0, o = e.length; t < o; ++t)e[t](); P._completes = [];
                    }
                }), A.beta && m();
            }, ready: function (e) {
                ...
                let n = function (e) {
                    let n = e.checkResult; for (let i in n) {
                        let t = h[i]; t && (n[t] = n[i], delete n[i]);
                    } return e;
                }; i("checkJsApi", { jsApiList: d(e.jsApiList) }, (e._complete = function (e) {
                    if (k) {
                        let i = e.checkResult; i && (e.checkResult = JSON.parse(i));
                    } e = n(e);
                }, e));
                ...
                t(g.onMenuShareAppMessage, {
                    complete: function (n) {
                        "favorite" === n.scene ? i("sendAppMessage", { title: e.title || y, desc: e.desc || "", link: e.link || location.href, img_url: e.imgUrl || "", type: e.type || "link", data_url: e.dataUrl || "" }) : i("sendAppMessage", { title: e.title || y, desc: e.desc || "", link: e.link || location.href, img_url: e.imgUrl || "", type: e.type || "link", data_url: e.dataUrl || "" }, e);
                    }
                }, e);
                ...
                !1 === B ? (B = !0, i("getLocalImgData", { localId: e.localId }, (e._complete = function (e) {
                    if (B = !1, O.length > 0) {
                        let n = O.shift(); wx.getLocalImgData(n);
                    }
                }, e))) : O.push(e);
            }, getNetworkType: function (e) {
                let n = function (e) {
                    let n = e.errMsg; e.errMsg = "getNetworkType:ok"; let i = e.subtype; if (delete e.subtype, i) e.networkType = i; else {
                        let t = n.indexOf(":"), o = n.substring(t + 1); switch (o) {
                            case "wifi": case "edge": case "wwan": e.networkType = o; break; default: e.errMsg = "getNetworkType:fail";
                        }
                    } return e;
                ...
                i("scanQRCode", { needResult: (e = e || {}).needResult || 0, scanType: e.scanType || ["qrCode", "barCode"] }, (e._complete = function (e) {
                    if (x) {
                        let n = e.resultStr; if (n) {
                            let i = JSON.parse(n); e.resultStr = i && i.scan_code && i.scan_code.scan_result;
                        }
                    }
                }, e));
                ...
                for (var n = e.cardList, t = [], o = 0, r = n.length; o < r; ++o) {
                    let a = n[o], c = { card_id: a.cardId, card_ext: a.cardExt }; t.push(c);
                } i(g.addCard, { card_list: t }, (e._complete = function (e) {
                    let n = e.card_list; if (n) {
                        for (let i = 0, t = (n = JSON.parse(n)).length; i < t; ++i) {
                            let o = n[i]; o.cardId = o.card_id, o.cardExt = o.card_ext, o.isSuccess = !!o.is_succ, delete o.card_id, delete o.card_ext, delete o.is_succ;
                ...
                for (var n = e.cardList, t = [], o = 0, r = n.length; o < r; ++o) {
                    let a = n[o], c = { card_id: a.cardId, code: a.code }; t.push(c);
        ...
        }, E = 1, b = {}; return S.addEventListener("error", function (e) {
            if (!k) {
                let n = e.target, i = n.tagName, t = n.src; if (("IMG" == i || "VIDEO" == i || "AUDIO" == i || "SOURCE" == i) && -1 != t.indexOf("wxlocalresource://")) {
                    e.preventDefault(), e.stopPropagation(); let o = n["wx-id"]; if (o || (o = E++, n["wx-id"] = o), b[o]) return; b[o] = !0, wx.ready(function () {
                        wx.getLocalImgData({
            ...
            if (!k) {
                let n = e.target, i = n.tagName; n.src; if ("IMG" == i || "VIDEO" == i || "AUDIO" == i || "SOURCE" == i) {
                    let t = n["wx-id"]; t && (b[t] = !1);
                }
            }
